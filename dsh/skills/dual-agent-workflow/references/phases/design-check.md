...
4. **逐项对照**：按 `docs/ai/QUALITY_GATES.md` 设计层闸门（5.1 UX / 5.2 UI / 5.3 美术内容 / 5.4 文案）自检（项目无此文件则从 `~/.dsh/workflow/QUALITY_GATES.md` 母本 scaffold），结果记入 HANDOFF 的 Quality Gates。