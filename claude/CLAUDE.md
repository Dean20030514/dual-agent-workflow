...
```bash
codex exec --sandbox workspace-write --ephemeral --ignore-user-config --ignore-rules -c 'windows.sandbox="elevated"' -m gpt-5.6-sol -c 'model_reasoning_effort="high"' -o docs/ai/codex_review_output.md "<prompt>" </dev/null > docs/ai/codex_review_raw.log 2>&1
```
